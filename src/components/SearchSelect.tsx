...
const SearchSelect = ({ onSelect, onSearch, children,value,selectCard,onClose,placeholder }: Props) => {
    console.log('key :>> ', selectCard);
    return (
        <>
           { value &&
            ...
            <div className="flex flex-col relative h-full">
              ...
              <div className="flex flex-row justify-start items-center  gap-4 h-full w-full ml-3 ">
                ...
                <img src={selectCard?.imageUrl} className="h-14 w-14 rounded-full" />
